...
import 'package:pdf_maker/screen/pdfview.dart';
import 'package:pdftron_flutter/pdftron_flutter.dart';

class Pptcontroller extends GetxController {
  ...
  Future<List<io.FileSystemEntity>> dirContents(io.Directory dir) {
    ...
    lister.listen((file) async {
      ...
      } else if (f.type == io.FileSystemEntityType.file && file.path.endsWith('.pptx')) {
        filessort.add(file);
